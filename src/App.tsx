      ...
      <header className="hero brand-watermark">
        ...
        <div className="hero-inner">
          <div className="title-row">
            ...
            <div>
              <h1>{title}</h1>
              <p className="subtitle">Your host is John Izokun | Klyvo AI | 5 minutes</p>
            </div>
          </div>
          <div className="hero-meta">
            {start && <span className="pill">Upcoming</span>}
            {start && <Countdown to={start} />}
            <a className="btn primary gold" href={bookingLink} target="_blank" rel="noreferrer">Book Your 10-Min Process Map</a>
            ...
            <a className="btn outline gold" href={bookingLink} target="_blank" rel="noreferrer">See if you qualify</a>
        ...
        <section className="card video-card gold-border">
          ...
          <div className="video-frame">
            <iframe
              width="100%"
              height="100%"
              src="https://www.loom.com/embed/82d5fd893d6a42ac8892b998d7d82cce?autoplay=1&muted=1"
